...
import static com.thermatk.java.tgemoji.Main.basePath;

// FROM https://github.com/DrKLO/Telegram/blob/master/TMessagesProj/src/main/java/org/telegram/messenger/EmojiData.java
public class EmojiData {
    ...
    public static void outputAllEmojis () {
        try {
            File fileOut = new File(basePath + "list.txt");
            if (!fileOut.exists()) {
    ...
    // FROM https://github.com/DrKLO/Telegram/blob/master/TMessagesProj/src/main/java/org/telegram/messenger/Emoji.java
